...
// FFXI Zone DAT Table
// Complete list of all 300 retail zones (IDs 0-299) with their model DAT file paths.
// Model DAT contains the MZB (zone object placement) and MMB (zone geometry) chunks.
// Source: "Complete List of Zone DATs by Zone ID" - credit to Devi Ltti for extraction.
//
// Usage:
//   const FFXIZoneEntry* entry = FFXIZone::FindByID(230); // Southern San d'Oria
//   if (entry && entry->modelDat[0]) LoadZone(entry->modelDat);

struct FFXIZoneEntry
{
    int         id;
    const char* name;       // display name; "(unnamed)" for zones with no known name
    const char* modelDat;   // path relative to FFXI root; "" if no model DAT known
    const char* dialogDat;  // NPC dialog strings DAT
    const char* npcDat;     // NPC placement/definition DAT
    const char* eventDat;   // event script DAT
};

static const FFXIZoneEntry kFFXIZoneTable[] =
{
//  { id,  name,                              modelDat,                dialogDat,              npcDat,                 eventDat              }
    {   0, "Jeuno Mog House",                  "ROM/1/20.DAT",          "",                     "",                     ""                    },
    ...
    { 133, "(unnamed)",                        "ROM/1/5.DAT",           "ROM/24/70.DAT",        "ROM/26/70.DAT",        "ROM/20/70.DAT"       },
    ...
    { 210, "(unnamed)",                        "ROM/0/40.DAT",          "ROM/25/19.DAT",        "ROM/27/19.DAT",        "ROM/21/19.DAT"       },
    ...
    { 229, "(unnamed)",                        "ROM/0/119.DAT",         "ROM/25/38.DAT",        "ROM/27/38.DAT",        "ROM/21/38.DAT"       },
    ...
    { 278, "(unnamed)",                        "ROM9/0/25.DAT",         "ROM9/5/123.DAT",       "ROM9/6/67.DAT",        "ROM9/5/75.DAT"       },
    { 279, "(unnamed)",                        "ROM9/0/26.DAT",         "ROM9/5/124.DAT",       "ROM9/6/68.DAT",        "ROM9/5/76.DAT"       },
...
namespace FFXIZone
{
    // Look up a zone entry by ID. Returns nullptr if id is out of range.
    inline const FFXIZoneEntry* FindByID(const int id)
    {
        if (id < 0 || id >= kFFXIZoneCount) return nullptr;
        return &kFFXIZoneTable[id];
    }

    // Returns true if the zone has a known model DAT.
    inline bool HasModel(const FFXIZoneEntry* pEntry)
    {
        return pEntry && pEntry->modelDat[0] != '\0';
    }
}

// ============================================================
// Lore region zone menu groupings - used by BuildMenuBar() in main.cpp
// Generated from tools/ffxiclopedia_lore_zone_dat_crossref.csv.
// The labels follow FFXIclopedia area grouping: continent/category / lore region.
// ============================================================

struct FFXIZoneGroup
{
    const char* name;
    const int*  ids;
    int         count;
...
static const int kZG_Lore_The_Middle_Lands_The_Republic_of_Bastok[] = {
    235, 234, 237, 236
};
static const int kZG_Lore_The_Middle_Lands_The_Kingdom_of_San_d_Oria[] = {
    233, 231, 232, 230
};
static const int kZG_Lore_The_Middle_Lands_The_Federation_of_Windurst[] = {
    242, 240, 239, 238, 241
};
static const int kZG_Lore_The_Middle_Lands_The_Grand_Duchy_of_Jeuno[] = {
    246, 245, 244, 243, 0
};
static const int kZG_Lore_The_Middle_Lands_Minor_Cities[] = {
    248, 249, 26
};
static const int kZG_Lore_The_Middle_Lands_Outland_Cities[] = {
    250, 252, 247
};
static const int kZG_Lore_The_Middle_Lands_Aragoneu[] = {
    152, 7, 8, 151, 200, 119, 120
};
static const int kZG_Lore_The_Middle_Lands_Derfland[] = {
    147, 197, 109, 148, 110
};
static const int kZG_Lore_The_Middle_Lands_Elshimo_Lowlands[] = {
    250, 252, 176, 123
};
static const int kZG_Lore_The_Middle_Lands_Elshimo_Uplands[] = {
    207, 211, 160, 205, 163, 159, 124
};
static const int kZG_Lore_The_Middle_Lands_Fauregandi[] = {
    111, 203, 204, 9, 206, 166, 10
};
static const int kZG_Lore_The_Middle_Lands_Gustaberg[] = {
    191, 173, 106, 143, 107, 144, 172
};
static const int kZG_Lore_The_Middle_Lands_Kolshushu[] = {
    4, 4, 118, 213, 3, 198, 249, 117
};
static const int kZG_Lore_The_Middle_Lands_Kuzotz[] = {
    209, 114, 168, 208, 247, 125
};
static const int kZG_Lore_The_Middle_Lands_Li_Telor[] = {
    153, 202, 154, 251, 122, 121
};
static const int kZG_Lore_The_Middle_Lands_Lumoria[] = {
    33, 35, 34, 36
};
static const int kZG_Lore_The_Middle_Lands_Movalpolos[] = {
    13, 12, 11
};
static const int kZG_Lore_The_Middle_Lands_Norvallen[] = {
    105, 2, 149, 195, 104, 150, 1
};
static const int kZG_Lore_The_Middle_Lands_Qufim[] = {
    127, 184, 157, 126, 179, 158
};
static const int kZG_Lore_The_Middle_Lands_Ronfaure[] = {
    167, 101, 141, 140, 139, 190, 100, 142
};
static const int kZG_Lore_The_Middle_Lands_Sarutabaruta[] = {
    146, 116, 170, 145, 192, 194, 169, 115
};
static const int kZG_Lore_The_Middle_Lands_Tavnazian_Archipelago[] = {
    24, 25, 31, 27, 30, 29, 28, 32
};
static const int kZG_Lore_The_Middle_Lands_Tavnazian_Marquisate[] = {
    26
};
static const int kZG_Lore_The_Middle_Lands_Tu_Lia[] = {
    181, 180, 130, 178, 177
};
static const int kZG_Lore_The_Middle_Lands_Valdeaunia[] = {
    6, 161, 162, 165, 5, 112, 229
};
static const int kZG_Lore_The_Middle_Lands_Vollbow[] = {
    113, 201, 212, 174, 128
};
static const int kZG_Lore_The_Middle_Lands_Zulkheim[] = {
    196, 108, 102, 193, 248, 103
};
static const int kZG_Lore_The_Aradjiah_Continent_The_Empire_of_Aht_Urhgan[] = {
    50, 48, 53
};
static const int kZG_Lore_The_Aradjiah_Continent_Arrapago_Islands[] = {
    54, 79, 78, 55, 69, 53, 56, 57, 60
};
static const int kZG_Lore_The_Aradjiah_Continent_Halvung_Territory[] = {
    62, 63, 61, 64
};
static const int kZG_Lore_The_Aradjiah_Continent_Mamool_Ja_Savagelands[] = {
    68, 67, 65, 66, 51
};
static const int kZG_Lore_The_Aradjiah_Continent_Ruins_of_Alzadaal[] = {
    72, 77, 76, 74, 75, 73
};
...
static const int kZG_Lore_The_Shadowreign_Era_The_Derfland_Front[] = {
    92, 171, 90, 91, 83
};
static const int kZG_Lore_The_Shadowreign_Era_The_Fauregandi_Front[] = {
    136
};
static const int kZG_Lore_The_Shadowreign_Era_The_Gustaberg_Front[] = {
    87, 89, 88, 93
};
static const int kZG_Lore_The_Shadowreign_Era_The_Norvallen_Front[] = {
    84, 175, 85, 82
};
static const int kZG_Lore_The_Shadowreign_Era_The_Ronfaure_Front[] = {
    81, 86, 80
};
static const int kZG_Lore_The_Shadowreign_Era_The_Sarutabaruta_Front[] = {
    96, 129, 94, 95
};
static const int kZG_Lore_The_Shadowreign_Era_The_Threshold[] = {
    182, 222
};
...
static const int kZG_Lore_The_Ulbuka_Continent_The_Adoulin_Islands[] = {
    257, 256, 284, 280, 258
};
static const int kZG_Lore_The_Ulbuka_Continent_East_Ulbuka_Territory[] = {
...
static const int kZG_Lore_Other_Areas_Limbus[] = {
    38, 37
};
static const int kZG_Lore_Other_Areas_Abyssea[] = {
    15, 132, 45, 215, 216, 217, 218, 254, 253, 255
};
static const int kZG_Lore_Other_Areas_Dynamis[] = {
    186, 188, 185, 187, 134, 135, 40, 41, 39, 42
};
static const int kZG_Lore_Other_Areas_Abdhaljs[] = {
    43, 44, 183, 287
};
static const int kZG_Lore_Other_Areas_Airships[] = {
    224, 226, 223, 225
};
static const int kZG_Lore_Other_Areas_Ferries[] = {
    221, 220, 46, 47, 59, 58, 3, 1, 228, 227, 283
};
static const int kZG_Lore_Other_Areas_Miscellaneous_Zones[] = {
    70, 285, 131
};
static const int kZG_Lore_Other_Areas_Escha[] = {
    288, 289
};
static const int kZG_Lore_Far_East_Reisenjima[] = {
    291, 292, 293
};
static const int kZG_Lore_Other_Areas_Desuetia[] = {
    290
};
static const int kZG_Lore_Other_Areas_Dynamis_Divergence[] = {
    294, 295, 296, 297
};
static const int kZG_Lore_Other_Areas_The_Threshold[] = {
    298, 279
};
...
{
    { "The Middle Lands / The Republic of Bastok", kZG_Lore_The_Middle_Lands_The_Republic_of_Bastok, (int)(sizeof(kZG_Lore_The_Middle_Lands_The_Republic_of_Bastok)/sizeof(kZG_Lore_The_Middle_Lands_The_Republic_of_Bastok[0])) },
    { "The Middle Lands / The Kingdom of San d'Oria", kZG_Lore_The_Middle_Lands_The_Kingdom_of_San_d_Oria, (int)(sizeof(kZG_Lore_The_Middle_Lands_The_Kingdom_of_San_d_Oria)/sizeof(kZG_Lore_The_Middle_Lands_The_Kingdom_of_San_d_Oria[0])) },
    { "The Middle Lands / The Federation of Windurst", kZG_Lore_The_Middle_Lands_The_Federation_of_Windurst, (int)(sizeof(kZG_Lore_The_Middle_Lands_The_Federation_of_Windurst)/sizeof(kZG_Lore_The_Middle_Lands_The_Federation_of_Windurst[0])) },
    { "The Middle Lands / The Grand Duchy of Jeuno", kZG_Lore_The_Middle_Lands_The_Grand_Duchy_of_Jeuno, (int)(sizeof(kZG_Lore_The_Middle_Lands_The_Grand_Duchy_of_Jeuno)/sizeof(kZG_Lore_The_Middle_Lands_The_Grand_Duchy_of_Jeuno[0])) },
    { "The Middle Lands / Minor Cities", kZG_Lore_The_Middle_Lands_Minor_Cities, (int)(sizeof(kZG_Lore_The_Middle_Lands_Minor_Cities)/sizeof(kZG_Lore_The_Middle_Lands_Minor_Cities[0])) },
    { "The Middle Lands / Outland Cities", kZG_Lore_The_Middle_Lands_Outland_Cities, (int)(sizeof(kZG_Lore_The_Middle_Lands_Outland_Cities)/sizeof(kZG_Lore_The_Middle_Lands_Outland_Cities[0])) },
    { "The Middle Lands / Aragoneu", kZG_Lore_The_Middle_Lands_Aragoneu, (int)(sizeof(kZG_Lore_The_Middle_Lands_Aragoneu)/sizeof(kZG_Lore_The_Middle_Lands_Aragoneu[0])) },
    { "The Middle Lands / Derfland", kZG_Lore_The_Middle_Lands_Derfland, (int)(sizeof(kZG_Lore_The_Middle_Lands_Derfland)/sizeof(kZG_Lore_The_Middle_Lands_Derfland[0])) },
    { "The Middle Lands / Elshimo Lowlands", kZG_Lore_The_Middle_Lands_Elshimo_Lowlands, (int)(sizeof(kZG_Lore_The_Middle_Lands_Elshimo_Lowlands)/sizeof(kZG_Lore_The_Middle_Lands_Elshimo_Lowlands[0])) },
    { "The Middle Lands / Elshimo Uplands", kZG_Lore_The_Middle_Lands_Elshimo_Uplands, (int)(sizeof(kZG_Lore_The_Middle_Lands_Elshimo_Uplands)/sizeof(kZG_Lore_The_Middle_Lands_Elshimo_Uplands[0])) },
    { "The Middle Lands / Fauregandi", kZG_Lore_The_Middle_Lands_Fauregandi, (int)(sizeof(kZG_Lore_The_Middle_Lands_Fauregandi)/sizeof(kZG_Lore_The_Middle_Lands_Fauregandi[0])) },
    { "The Middle Lands / Gustaberg", kZG_Lore_The_Middle_Lands_Gustaberg, (int)(sizeof(kZG_Lore_The_Middle_Lands_Gustaberg)/sizeof(kZG_Lore_The_Middle_Lands_Gustaberg[0])) },
    { "The Middle Lands / Kolshushu", kZG_Lore_The_Middle_Lands_Kolshushu, (int)(sizeof(kZG_Lore_The_Middle_Lands_Kolshushu)/sizeof(kZG_Lore_The_Middle_Lands_Kolshushu[0])) },
    { "The Middle Lands / Kuzotz", kZG_Lore_The_Middle_Lands_Kuzotz, (int)(sizeof(kZG_Lore_The_Middle_Lands_Kuzotz)/sizeof(kZG_Lore_The_Middle_Lands_Kuzotz[0])) },
    { "The Middle Lands / Li'Telor", kZG_Lore_The_Middle_Lands_Li_Telor, (int)(sizeof(kZG_Lore_The_Middle_Lands_Li_Telor)/sizeof(kZG_Lore_The_Middle_Lands_Li_Telor[0])) },
    { "The Middle Lands / Lumoria", kZG_Lore_The_Middle_Lands_Lumoria, (int)(sizeof(kZG_Lore_The_Middle_Lands_Lumoria)/sizeof(kZG_Lore_The_Middle_Lands_Lumoria[0])) },
    { "The Middle Lands / Movalpolos", kZG_Lore_The_Middle_Lands_Movalpolos, (int)(sizeof(kZG_Lore_The_Middle_Lands_Movalpolos)/sizeof(kZG_Lore_The_Middle_Lands_Movalpolos[0])) },
    { "The Middle Lands / Norvallen", kZG_Lore_The_Middle_Lands_Norvallen, (int)(sizeof(kZG_Lore_The_Middle_Lands_Norvallen)/sizeof(kZG_Lore_The_Middle_Lands_Norvallen[0])) },
    { "The Middle Lands / Qufim", kZG_Lore_The_Middle_Lands_Qufim, (int)(sizeof(kZG_Lore_The_Middle_Lands_Qufim)/sizeof(kZG_Lore_The_Middle_Lands_Qufim[0])) },
    { "The Middle Lands / Ronfaure", kZG_Lore_The_Middle_Lands_Ronfaure, (int)(sizeof(kZG_Lore_The_Middle_Lands_Ronfaure)/sizeof(kZG_Lore_The_Middle_Lands_Ronfaure[0])) },
    { "The Middle Lands / Sarutabaruta", kZG_Lore_The_Middle_Lands_Sarutabaruta, (int)(sizeof(kZG_Lore_The_Middle_Lands_Sarutabaruta)/sizeof(kZG_Lore_The_Middle_Lands_Sarutabaruta[0])) },
    { "The Middle Lands / Tavnazian Archipelago", kZG_Lore_The_Middle_Lands_Tavnazian_Archipelago, (int)(sizeof(kZG_Lore_The_Middle_Lands_Tavnazian_Archipelago)/sizeof(kZG_Lore_The_Middle_Lands_Tavnazian_Archipelago[0])) },
    { "The Middle Lands / Tavnazian Marquisate", kZG_Lore_The_Middle_Lands_Tavnazian_Marquisate, (int)(sizeof(kZG_Lore_The_Middle_Lands_Tavnazian_Marquisate)/sizeof(kZG_Lore_The_Middle_Lands_Tavnazian_Marquisate[0])) },
    { "The Middle Lands / Tu'Lia", kZG_Lore_The_Middle_Lands_Tu_Lia, (int)(sizeof(kZG_Lore_The_Middle_Lands_Tu_Lia)/sizeof(kZG_Lore_The_Middle_Lands_Tu_Lia[0])) },
    { "The Middle Lands / Valdeaunia", kZG_Lore_The_Middle_Lands_Valdeaunia, (int)(sizeof(kZG_Lore_The_Middle_Lands_Valdeaunia)/sizeof(kZG_Lore_The_Middle_Lands_Valdeaunia[0])) },
    { "The Middle Lands / Vollbow", kZG_Lore_The_Middle_Lands_Vollbow, (int)(sizeof(kZG_Lore_The_Middle_Lands_Vollbow)/sizeof(kZG_Lore_The_Middle_Lands_Vollbow[0])) },
    { "The Middle Lands / Zulkheim", kZG_Lore_The_Middle_Lands_Zulkheim, (int)(sizeof(kZG_Lore_The_Middle_Lands_Zulkheim)/sizeof(kZG_Lore_The_Middle_Lands_Zulkheim[0])) },
    { "The Aradjiah Continent / The Empire of Aht Urhgan", kZG_Lore_The_Aradjiah_Continent_The_Empire_of_Aht_Urhgan, (int)(sizeof(kZG_Lore_The_Aradjiah_Continent_The_Empire_of_Aht_Urhgan)/sizeof(kZG_Lore_The_Aradjiah_Continent_The_Empire_of_Aht_Urhgan[0])) },
    { "The Aradjiah Continent / Arrapago Islands", kZG_Lore_The_Aradjiah_Continent_Arrapago_Islands, (int)(sizeof(kZG_Lore_The_Aradjiah_Continent_Arrapago_Islands)/sizeof(kZG_Lore_The_Aradjiah_Continent_Arrapago_Islands[0])) },
    { "The Aradjiah Continent / Halvung Territory", kZG_Lore_The_Aradjiah_Continent_Halvung_Territory, (int)(sizeof(kZG_Lore_The_Aradjiah_Continent_Halvung_Territory)/sizeof(kZG_Lore_The_Aradjiah_Continent_Halvung_Territory[0])) },
    ...
    { "The Shadowreign Era / The Gustaberg Front", kZG_Lore_The_Shadowreign_Era_The_Gustaberg_Front, (int)(sizeof(kZG_Lore_The_Shadowreign_Era_The_Gustaberg_Front)/sizeof(kZG_Lore_The_Shadowreign_Era_The_Gustaberg_Front[0])) },
    { "The Shadowreign Era / The Norvallen Front", kZG_Lore_The_Shadowreign_Era_The_Norvallen_Front, (int)(sizeof(kZG_Lore_The_Shadowreign_Era_The_Norvallen_Front)/sizeof(kZG_Lore_The_Shadowreign_Era_The_Norvallen_Front[0])) },
    { "The Shadowreign Era / The Ronfaure Front", kZG_Lore_The_Shadowreign_Era_The_Ronfaure_Front, (int)(sizeof(kZG_Lore_The_Shadowreign_Era_The_Ronfaure_Front)/sizeof(kZG_Lore_The_Shadowreign_Era_The_Ronfaure_Front[0])) },
    ...
    { "The Ulbuka Continent / Ra'Kaznar", kZG_Lore_The_Ulbuka_Continent_Ra_Kaznar, (int)(sizeof(kZG_Lore_The_Ulbuka_Continent_Ra_Kaznar)/sizeof(kZG_Lore_The_Ulbuka_Continent_Ra_Kaznar[0])) },
    { "Other Areas / Promyvion", kZG_Lore_Other_Areas_Promyvion, (int)(sizeof(kZG_Lore_Other_Areas_Promyvion)/sizeof(kZG_Lore_Other_Areas_Promyvion[0])) },
    { "Other Areas / Limbus", kZG_Lore_Other_Areas_Limbus, (int)(sizeof(kZG_Lore_Other_Areas_Limbus)/sizeof(kZG_Lore_Other_Areas_Limbus[0])) },
    { "Other Areas / Abyssea", kZG_Lore_Other_Areas_Abyssea, (int)(sizeof(kZG_Lore_Other_Areas_Abyssea)/sizeof(kZG_Lore_Other_Areas_Abyssea[0])) },
    { "Other Areas / Dynamis", kZG_Lore_Other_Areas_Dynamis, (int)(sizeof(kZG_Lore_Other_Areas_Dynamis)/sizeof(kZG_Lore_Other_Areas_Dynamis[0])) },
    { "Other Areas / Abdhaljs", kZG_Lore_Other_Areas_Abdhaljs, (int)(sizeof(kZG_Lore_Other_Areas_Abdhaljs)/sizeof(kZG_Lore_Other_Areas_Abdhaljs[0])) },
    { "Other Areas / Airships", kZG_Lore_Other_Areas_Airships, (int)(sizeof(kZG_Lore_Other_Areas_Airships)/sizeof(kZG_Lore_Other_Areas_Airships[0])) },
    { "Other Areas / Ferries", kZG_Lore_Other_Areas_Ferries, (int)(sizeof(kZG_Lore_Other_Areas_Ferries)/sizeof(kZG_Lore_Other_Areas_Ferries[0])) },
    { "Other Areas / Miscellaneous Zones", kZG_Lore_Other_Areas_Miscellaneous_Zones, (int)(sizeof(kZG_Lore_Other_Areas_Miscellaneous_Zones)/sizeof(kZG_Lore_Other_Areas_Miscellaneous_Zones[0])) },
    { "Other Areas / Escha", kZG_Lore_Other_Areas_Escha, (int)(sizeof(kZG_Lore_Other_Areas_Escha)/sizeof(kZG_Lore_Other_Areas_Escha[0])) },
    { "Far East / Reisenjima", kZG_Lore_Far_East_Reisenjima, (int)(sizeof(kZG_Lore_Far_East_Reisenjima)/sizeof(kZG_Lore_Far_East_Reisenjima[0])) },
    { "Other Areas / Desuetia", kZG_Lore_Other_Areas_Desuetia, (int)(sizeof(kZG_Lore_Other_Areas_Desuetia)/sizeof(kZG_Lore_Other_Areas_Desuetia[0])) },
    { "Other Areas / Dynamis-Divergence", kZG_Lore_Other_Areas_Dynamis_Divergence, (int)(sizeof(kZG_Lore_Other_Areas_Dynamis_Divergence)/sizeof(kZG_Lore_Other_Areas_Dynamis_Divergence[0])) },
